...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="../../pages/apprenant.html">LES APPRENANTS</a></li>
                    <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #222222;">CONTACT <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="contact-projet.php">SOUMETTRE UN PROJET</a></li>
                            <li class="active"><a href="contact-apprenant.php" style="color: #222222;">RECRUTER UN APPRENANT</a></li>
    ...
    <section class="descriptionFormulaire fond">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p style="color:black;">Vous recherchez des talents en développement web ou charge de projets numériques? Optimisez vos recrutements et valorisez votre marque employeur. Nos apprenants sont disponibles dès septembre 2016 en contrat de professionnalisation ou pour l'embauche.</p>
                </div>
            </div>
        </div>
    </section>
