...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="contact-apprenant.php" style="color: #222222;"><i class="fa fa-user-plus"></i> RECRUTER UN APPRENANT</a></li>
    ...
    <section class="descriptionFormulaire fond">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p style="color:black;" class="text-center">Vous recherchez des talents en développement web ou charge de projets numériques? Optimisez vos recrutements et valorisez votre marque employeur. Nos apprenants sont disponibles dès septembre 2016 en contrat de professionnalisation ou pour l'embauche.</p>
                </div>
            </div>
        </div>
    </section>
